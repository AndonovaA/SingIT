...
public class LrcView extends View implements ILrcView {
    ...
    private final int mMinSeekFiredOffset = 5; // min offset for fire seek action, px;
    private int mHighlightRow = 0;   // current singing row , should be highlighted.
    private final int mHighlightRowColor = Color.YELLOW;
    ...
    private final int mMinSeekLineTextSize = 20;
    private final int mMaxSeekLineTextSize = 40;
    private int mLrcFontSize = 30;    // font size of lrc
    private final int mMinLrcFontSize = 20;
    private final int mMaxLrcFontSize = 40;
    ...
    private void doSeek(MotionEvent event) {
        ...
        Log.d(TAG, "move new highlightrow : " + mHighlightRow + " offsetY: " + offsetY + " rowOffset:" + rowOffset);
        if (offsetY < 0) {
            // finger move up
